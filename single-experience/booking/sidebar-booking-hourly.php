...
$start_hour = get_post_meta($experience_id, $homey_prefix.'start_hour', true);
$end_hour = get_post_meta($experience_id, $homey_prefix.'end_hour', true);
	...
	<div class="block">
		<div class="sidebar-booking-module-header">
			<div class="block-body-sidebar">
					...
					<?php 	
					echo homey_formatted_price($experience_price, false, true); ?><sub><?php echo esc_attr($price_separator); ?><?php echo homey_get_price_label();?></sub>
					</span>
		...
		<div class="sidebar-booking-module-body">
			...
			<?php 
				...
				<div id="single-experience-date-range" class="search-date-range">
					...
					<div id="single-booking-search-calendar" class="search-calendar search-calendar-single clearfix single-experience-booking-calendar-js hourly-js-desktop clearfix" style="display: none;">
						<?php homeyHourlyAvailabilityCalendar(); ?>

						<div class="calendar-navigation custom-actions">
	                        <button class="experience-cal-prev btn btn-action pull-left disabled"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>
	                        <button class="experience-cal-next btn btn-action pull-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>
...
<div class="sidebar-booking-module-footer">
	<div class="block-body-sidebar">
		...
		<button type="button" data-exp-id="<?php echo intval($post->ID); ?>" class="add_exp_fav btn btn-full-width btn-grey-outlined"><i class="fa <?php echo esc_attr($heart); ?>" aria-hidden="true"></i> <?php echo esc_attr($favorite); ?></button>
		<?php } ?>
		...
		<button type="button" id="homey-print" class="btn btn-full-width btn-blank" data-experience-id="<?php echo intval($experience_id);?>">
